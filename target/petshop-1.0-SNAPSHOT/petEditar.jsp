          ...
          <div class="row text-center" style=" padding-top: 100px !important;">
            ...
            <div class="col-md-6" >
              <form class="" action="/PetShop/pet/alterar" method="post">
               ...
               <div class="form-group col-sm-12">
                <div class="col-sm-12">
                  <input type="text" class="form-control form-control-lg" name="raca" id="raca" placeholder="Raça" value="${pet.raca}">
                </div>
              </div>
              <div class="form-group col-sm-12">
               <div class="col-sm-12">
                 <input type="text" class="form-control form-control-lg" name="especie" id="especie" placeholder="Especíe" value="${pet.especie}">
               </div>
              </div>
              <div class="form-group col-sm-12">
                <div class="col-sm-12">
              ...
              <div class="form-group col-sm-12" style="padding-left: 30px;padding-right: 30px;">
                <select class="form-control form-control-lg" name="sexo" id="sexo">
                   ...
                   <option value="0" ${pet.sexo == 'F' ? 'selected' : ""}>Femêa</option>
                 </select>
             </div>
             <div class="form-group col-sm-12" style="padding-left: 30px;padding-right: 30px;">
